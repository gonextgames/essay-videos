  ...
  yield view.add(
    <Layout layout direction={"column"} gap={0} width={1920} height={1080}>
        <Rect grow={1} padding={30} paddingLeft={50} clip fill={"#242424"} direction={"row"} gap={30}>
            <Image src={gitImage} width={50} height={50}/>
            <Text fill={"#ccc"} fontSize={35} lineHeight={50} fontFamily={'JetBrains Mono'}>potionMerchants/potionShmotion</Text>
        </Rect>
          ...
          <Rect grow={6} fill={"#202020"} direction={"column"} paddingLeft={30} paddingRight={30}>
            ...
            <Rect grow={9}>
              <Rect width={"100%"} height={700} padding={30}>
                <CodeBlock ref={filesRef} language={`c#`} fill={"#ccc"} fontSize={35} lineHeight={50} fontFamily={'JetBrains Mono'} code={folder}></CodeBlock>
              </Rect>
            </Rect>
          </Rect>
          <Rect padding={50} grow={2} direction={"column"}>
            {/* <Text fill={"#aaa"} fontSize={35} lineHeight={50} fontFamily={'JetBrains Mono'}>A fun game about potions</Text> */}
          </Rect>
        </Rect>
    </Layout>
  )
